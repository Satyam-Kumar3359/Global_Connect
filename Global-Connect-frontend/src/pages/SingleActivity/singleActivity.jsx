...
const SingleActivity = () => {
    ...
    const fetchDataOnLoad = async () => {
        try {
            ...
            console.log('Attempting API call to:', `https://global-connect-05.onrender.com/api/post/getPostById/${postId}`);
            ...
            const res = await axios.get(`https://global-connect-05.onrender.com/api/post/getPostById/${postId}`);
