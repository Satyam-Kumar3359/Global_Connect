...
//       console.log('Personal Data:', userData.data.user);
...
//   // Handle repost callback - refresh posts or add new repost to feed
//   const handleRepost = (newRepost) => {
//     // Add the new repost to the beginning of the feed
//     if (newRepost && newRepost.post) {
//       setPost(prevPosts => [newRepost.post, ...prevPosts]);
//     }
//   }

//   // Handle new post creation (you can call this from AddModal)
              ...
              <img
                src={
                  personalData?.profilePic
                    ? personalData.profilePic.startsWith('http://')
                      ? personalData.profilePic.replace('http://', 'https://')
                      : personalData.profilePic
